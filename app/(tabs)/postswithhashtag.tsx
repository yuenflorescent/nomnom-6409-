...
import { router, Link, useFocusEffect, useLocalSearchParams } from 'expo-router';
...
const postswithHashtag = () => {
  const [posts, setPosts] = useState<Post[]>([]);
  const [refreshing, setRefreshing] = useState(false);
  const [likedPosts, setLikedPosts] = useState<{ [key: string]: boolean }>({});
  const hashtag: any = useLocalSearchParams()
...
export default postswithHashtag
